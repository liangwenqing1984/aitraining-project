...
const columnLabelMap: Record<string, string> = {
  ...
  jobCategory: '职位分类',
  dataSource: '数据来源',
  // sp_job_enrichments 增强字段（经camelCase转换）
  salaryMonthlyMin: '月薪下限',
  salaryMonthlyMax: '月薪上限',
  salaryAnnualEstimate: '预估年薪',
  jobCategoryL1: '职位大类',
  jobCategoryL2: '职位小类',
  ...
  educationNormalized: '学历(标准)',
  experienceYearsMin: '经验年限(低)',
  experienceYearsMax: '经验年限(高)',
  benefits: '福利待遇',
  workMode: '工作模式',
}
